...
const WasItParked = () => {
  ...
  const numberOfDrivers = useMemo(() => ([
    {
        id: '0',
        label: 'Yes, it was parked',
        value: 'Yes, it was parked',
        route: 'noneNavScreens/claims/accDesc/atWhichLocation',
    },
    {
        id: '1',
        label: 'No, it was not parked',
        value: 'No, it was not parked',
        route: 'noneNavScreens/claims/accDesc/iWasHitted/byVehicle/notParked',
    }
]), []);
...
const hundleClick = clicked =>{
  ...
  return (
    ...
    <View style={styles.container}>
      <Text style={styles.sectionText}>Was your vehicle parked?</Text>
      <FlatList
        bounces={false}
